  ...
  const content: Record<StatusType, JSX.Element> = {
    ...
    'ready': (
      <form onSubmit={handleSubmit} className="c-form">
        ...
        <GridRow modFormField>
          <GridElement width={6}>
            <TextField label='Förnamn' id="firstname" onChange={updateForm} value={formAnswers["firstname"]?.value} type="text" required />
          </GridElement>
          <GridElement width={6}>
            <TextField label='Efternamn' id="lastname" onChange={updateForm} value={formAnswers["lastname"]?.value} type="text" required/>
          </GridElement>
        </GridRow>
        ...
        <GridRow modFormField>
          <GridElement width={6}>
            <TextField label='E-post' id="email" onChange={updateForm} value={formAnswers["email"]?.value} type="email" required/>
          </GridElement>
          <GridElement width={6}>
        ...
        <GridRow modFormField>
          <GridElement width={12}>
            <TextField label='Övrig information' id="comment" onChange={updateForm} value={formAnswers["comment"]?.value} type="text"/>
          </GridElement>
        </GridRow>
