...
namespace ModularityMhBooking\Helper;
...
class CacheBust
{
    ...
    {
        $jsonPath = MODULARITY_MH_BOOKING_PATH . apply_filters(
            'ModularityMhBooking/Helper/CacheBust/RevManifestPath',
            'dist/manifest.json'
        );
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITY_MH_BOOKING_PATH . ' and run gulp. See ' . MODULARITY_MH_BOOKING_PATH . 'README.md for more info.</div>';
        }
    }
}
