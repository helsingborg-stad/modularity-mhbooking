...
if (!function_exists('modularity_mhbooking_render_blade_view')) {
    function modularity_mhbooking_render_blade_view($view, $data = [], $compress = true)
    {
        $init = new ComponentLibraryInit([
            MODULARITY_MH_BOOKING_MODULE_VIEW_PATH
        ]);
